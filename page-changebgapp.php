...
<section class="main animated fadeIn">
	<div class="row">
		<div id="about-text" class="col-sm-5">
			...
			<p class="description">
				<a target="_blank" href="<?php $link = get_field('link'); echo $link;?>">
					LAUNCH PROJECT
				</a>
			</p>
		...
		<div id="img-main" class="">		
			<img class="react-app" src="<?php $image = get_field('project_image'); echo $image['url'];?>" />
		</div>
	</div>
</section>
