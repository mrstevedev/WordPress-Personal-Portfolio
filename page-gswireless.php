...
<section class="main animated fadeIn">
	<div class="row">
		<div id="about-text" class="col-sm-5 col-md-4 col-lg-5">
			...
			<p class="subtext"><?php $sub_desc = get_field('sub_title'); echo $sub_desc;?></p>
			<p class="description"><?php $desc = get_field('description', false, false); echo $desc;?></p>
			<p class="description"><span class="subtext">Technologies:</span><?php $technologies = 
